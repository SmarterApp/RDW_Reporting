...
describe('withinBounds', () => {
  ...
  it('should return null when effective school years are within available school years ', () => {
    expect(withinBounds(4, ['01', '02', '03'], [1, 2, 3, 4], 'fail').call(this)).toBeNull();
  });

  it('should handle noncontiguous assessment grades ', () => {
    expect(withinBounds(4, ['01', '04'], [1, 2, 3, 4], 'fail').call(this)).toBeNull();
  });

  it('should return properties when out of bounds ', () => {
    expect(withinBounds(4, ['01', '10'], [1, 2, 3, 4], 'fail').call(this)).toEqual({withinBounds: 'fail'});
  });

...
describe('AssessmentResultsComponent', () => {
  ...
  mockOrderingService.getScorableClaimOrdering.and.callFake(() => of(ordering(byString)));
...
class TestComponentWrapper {
  assessment: AssessmentExam;
  constructor() {
    this.assessment = new AssessmentExam();
    this.assessment.assessment.claimCodes = [];
  }
